...
Color PunctualLight::intensityAt(const MatouMalin::Point & point,const Scene & scene, Renderable* currentObject) const
{
    ...
    // Check if there is an object between them. Ask for at least 2 intersections points with the scene as the ray will always intersect with the object containing the point point.
